...
my $pasmo_in = 12500;			# pasmo wejsciowe glownej kolejki HTB
my $pasmo_out = 3750;			#pasmo wyjsciowe glównej kolejki HTB
my $pasmo_max_download = 12000;		# dopuszczalne pasmo wejsciowe do podzialu dla userow
my $pasmo_max_upload = 3500;		#dopuszczalne pasmo wyjsciowe do podzialu dla userow
my $user_max = 52;			# liczba userów
my $wsp_rezerwy_up = 2;			# minimalna ilosc wolnego pasma upload dla usera
...
my $tbf_latency_up = 300;		# czas przetrzymywania w kolejce TBF  w [ms] \ _  dla wyjscia
my $tbf_burst_up = 252000;		# wielkosc bufora kolejki TBF w bajtach      /

my $tbf_latency_down = 500;		#  		-||- 			     \ _  dla wejscia
my $tbf_burst_down = 700000;		#  		-||-			     /
...
if ( $show > 0 ) {
  print "\t\t\t\tSuma Download : $fulldownload\t Suma Upload : $fullupload\n";
  
  print "\n       Razem Download : $suma_download\t       Razem Upload : $suma_upload\n";
  print "	wykorzystanie : $uzyty_download      \twykorzystanie : $uzyty_upload\n\n";
}
if ( $show > 2 ) {
